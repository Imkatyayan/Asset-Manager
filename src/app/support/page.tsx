            ...
            {contactSent ? (
              ...
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    id="contact-message"
                    className="w-full rounded-lg border border-market-border bg-market-surface px-3.5 py-2.5 text-sm text-market-text placeholder:text-market-muted transition-colors focus:border-market-accent focus:outline-none focus:ring-1 focus:ring-market-accent/30"
                    rows={4}
